			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="<?php echo e(asset('admin/assets/logo-dark.png')); ?>" alt="Klorofil Logo"></div>
...
<?php /**PATH C:\xampp\htdocs\tugas4\resources\views/auths/login.blade.php ENDPATH**/ ?>